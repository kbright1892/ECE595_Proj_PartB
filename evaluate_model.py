...
# training accuracies are only returned for one-time evaluation and if a second keyword argument is passed since they're not always needed
# requires the number of features as a command line argument, either when calling this directly or when calling this from another function
